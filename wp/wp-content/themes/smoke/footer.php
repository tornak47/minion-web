...
<div style="clear:both;"></div>
  ...
  <div class="grid_16 footer-register">
    <div class="register grid_12">
      <p>Copright 2010 iamthemes.com. All rights reserved. W3C standart web site valid xhtml and css</p>
      <p>www.themeforest.net</p>
    </div>
    <div class="grid_4 footer-logo">
      <img src="<?php bloginfo('template_directory'); ?>/image/iam.png" alt="">
    </div>
  </div>
