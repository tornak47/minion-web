...
<link rel="shotcut icon" href="http://www.minioninteractive.co.nz/wp/wp-content/uploads/2011/11/favicon.ico">
...
<div class="container_16">
  ...
  <a href="<?php bloginfo('url'); ?>">
          ...
          <a href="<?php echo home_url( '/' ); ?>" class="logo" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php get_option_tree( 'logo', '', 'true' ); ?>" alt="" /></a>
          <?php else : ?>
